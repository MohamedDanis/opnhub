...
>(({ className, ...props }, ref) => (
  <div
    className="flex items-center rounded-lg border px-3 bg-white"
    cmdk-input-wrapper=""
  >
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex  w-full rounded-md bg-transparent py-2 text-sm outline-none placeholder:text-slate-500 disabled:cursor-not-allowed disabled:opacity-50 ",
        className,
      )}
      {...props}
    />
